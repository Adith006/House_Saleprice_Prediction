...
page = st.sidebar.radio("Go To",("Homepage","Details","About"))
...
if page == "About":
    ...
    st.title("Conclusion")
    st.write("* In this project we have worked over price prediction of House Sale Price using Advanced Regression techniques ")
    st.write("* In this project we have observed and worked on advanced EDA and determined the sales price with the lowest Root Mean Square Error")
    st.write("* This project gave us a lot of insights and factors that would affect the SalePrice of the house and the predictions")
